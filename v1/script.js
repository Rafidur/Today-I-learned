...
async function loadFacts() {
  //Laad data fromsupabase
  const res = await fetch(
    "https://qzzyjybcanedfhhomhbg.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF6enlqeWJjYW5lZGZoaG9taGJnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjE5MTEyMDUsImV4cCI6MjAzNzQ4NzIwNX0.5jhgyF5MBzrQKTQLGtQXIJut8THvniFa89pXVFLsJlA",
      },
    }
  );
